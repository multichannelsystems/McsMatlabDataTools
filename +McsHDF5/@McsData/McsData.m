...
% McsData
% 
% Basic class to read and store the contents of a HDF5 file generated by
% MCS software.
%
% Usage:
%
...
%   21.02.2014
    ...
    methods
        ...
        % function md = McsData(filename)
        %
        % Reads a HDF5 file created by MCS software. This command will just
        % read the meta-information in the file, the actual data will be
        % read lazily, i.e. once it is needed (e.g. when plot is called).
        %
        % Input:
