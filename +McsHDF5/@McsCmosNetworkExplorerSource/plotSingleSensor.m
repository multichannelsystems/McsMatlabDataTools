...
%
%%  INIT FIGURE
    fig = figure('NumberTitle', 'off', 'Name', sprintf('Sensor (%d,%d)',coordinates(1),coordinates(2)), 'Tag','Unit', 'WindowButtonDownFcn', @McsHDF5.McsCmosNetworkExplorerSource.mouseSingleSensor);
    set(fig, 'WindowButtonDownFcn',@McsHDF5.McsCmosNetworkExplorerSource.mouseSingleSensor);
%
%%  CREATE LAYOUT
